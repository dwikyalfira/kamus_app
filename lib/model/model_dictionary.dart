...
List<ModelDictionary> modelDictionaryFromJson(String str) => List<ModelDictionary>.from(json.decode(str).map((x) => ModelDictionary.fromJson(x)));

String modelDictionaryToJson(List<ModelDictionary> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class ModelDictionary {
  ...
  factory ModelDictionary.fromJson(Map<String, dynamic> json) => ModelDictionary(
    word: json["word"],
